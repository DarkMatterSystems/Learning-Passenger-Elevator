...
typedef adm_base_integer_typ adm_int_floor_typ;

typedef adm_base_boolean_typ adm_bln_flag_typ;

typedef enum {
    ADM_LITERAL_DIRECTION_UP,
    ADM_LITERAL_DIRECTION_DOWN
} adm_enm_direction_typ;
